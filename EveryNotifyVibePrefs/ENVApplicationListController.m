...
- (NSArray *)specifiers {
    ...
    if (userApps.count > 0) {
        ...
        [group setProperty:@"Turn an app off to stop EveryNotifyVibe from adding its forced vibration for that app. The app then uses normal iOS notification vibration behaviour." forKey:@"footerText"];
